      ...
      <aside className="w-64 border-r border-border/50 bg-card flex flex-col relative z-10 shrink-0 shadow-[4px_0_24px_rgba(0,0,0,0.5)]">
        <div className="h-16 flex items-center px-6 border-b border-border/50">
          ...
          <div className="flex flex-col">
            ...
            <span className="font-mono text-[10px] text-muted-foreground uppercase mt-1">SOC Platform v1.0.0</span>
          </div>
        </div>
          ...
          {navItems.map((item) => {
            ...
            return (
              <Link 
                ...
                href={item.href}
                className={cn(
                  "flex items-center gap-3 px-3 py-2.5 rounded-sm font-display tracking-wider uppercase text-sm transition-all group relative",
                  isActive 
        ...
        <div className="p-4 border-t border-border/50 bg-muted/20">
          <div className="flex items-center gap-3">
            ...
            <span className="font-mono text-xs text-muted-foreground">SYSTEM SECURE</span>
          </div>
        </div>
      </aside>
        ...
        <header className="h-16 border-b border-border/50 flex items-center justify-between px-6 bg-card/50 backdrop-blur-sm z-10">
          <div className="flex items-center gap-4">
            <span className="font-mono text-xs text-muted-foreground flex items-center gap-2">
              <span className="text-primary">&gt;</span> DEFCON LEVEL 4
            </span>
          </div>
          <div className="flex items-center gap-4 font-mono text-xs">
            <div className="flex items-center gap-2 text-muted-foreground">
              <span>OP_ID:</span>
              <span className="text-foreground">ANALYST_01</span>
            </div>
